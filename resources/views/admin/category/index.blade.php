...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <h1 class="h4">{{ __('label.categories') }}</h1>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{ __('label.categories') }}</li>
                    </ol>
                </nav>
            </div>
            <!-- /.col-12 -->
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-sm btn-primary me-2"
                                                href="{{ route('admin.category.show', $category) }}" role="button">
                                                <i class="bi bi-eye"></i>
                                                {{ __('label.show') }}
                                            </a>
